...
var LEGAL_CONTENT = {
  disclaimer: {
    title: '免責聲明',
    html: '<h3>重要聲明：本站不提供投資顧問服務</h3><p>CT Investments 謙堂資本為<strong>股票資訊分析工具平台</strong>，依據公開資訊提供數據整理與技術分析工具。本站<strong>不具備證券投資顧問事業資格</strong>，亦不從事任何形式之投資顧問業務。</p><p>本站所有資訊、圖表、分析工具及觀察清單等內容，均<strong>僅供使用者自行研究參考</strong>，不構成任何買進、賣出或持有之投資建議或推薦。</p><h3>投資風險警告</h3><p>投資涉及風險，股票價格可能大幅波動。過去的績效不保證未來的收益。使用者應根據自身財務狀況、風險承受能力及投資目標，自行做出投資判斷，並對其投資決策承擔全部責任。</p><h3>資料來源說明</h3><p>本站股票數據來自台灣證券交易所（TWSE）、證券櫃檯買賣中心（TPEx）、Yahoo Finance 及 FinMind 等公開資訊來源。我們盡力確保資料準確，但不對資料的即時性、完整性或正確性做出任何保證。資料可能存在延遲、遺漏或錯誤。</p><h3>AI 工具免責</h3><p>本站 AI 分析功能係基於歷史數據與統計模型自動產出之分析結果，僅為輔助研究工具，不代表任何投資建議。其結果可能存在誤差，使用者應自行判斷。</p><h3>責任限制</h3><p>CT Investments 謙堂資本及其開發團隊不對因使用本站資訊或工具而直接或間接產生的任何投資損失或其他損害負責。</p>'
  },
  privacy: {
    title: '隱私權政策',
  ...
  terms: {
    title: '服務條款',
    html: '<h3>服務說明</h3><p>CT Investments 謙堂資本提供台灣股票市場<strong>資訊查詢與技術分析工具</strong>服務。本站為資料分析工具平台，不提供投資顧問、代操或證券經紀服務。</p><h3>帳號規範</h3><ul><li>每人限註冊一個帳號</li><li>帳號不得轉讓或與他人共用</li><li>使用者應妥善保管帳號密碼</li></ul><h3>付費方案</h3><ul><li>Free 方案永久免費</li><li>Pro / Pro+ 方案提供進階分析工具功能</li><li>Pro / Pro+ 方案提供 7 天免費試用</li><li>試用期間可隨時取消，不收取任何費用</li><li>試用期滿後自動轉為月繳</li></ul><h3>退費政策</h3><ul><li>年繳方案：購買後 14 天內可申請全額退費</li><li>月繳方案：當月不退費，可取消下月續訂</li><li>退費請聯繫 chan010212@gmail.com</li></ul><h3>免責條款</h3><p>本站提供之所有資訊、分析工具、觀察清單等內容，均不構成投資建議。使用者使用本站工具所做的任何投資決策，應自行承擔風險與結果。</p><h3>服務變更</h3><p>我們保留隨時修改服務內容、價格及條款之權利，變更將於網站上公告。</p>'
  }
};
